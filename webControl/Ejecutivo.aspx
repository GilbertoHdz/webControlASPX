<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Ejecutivo.aspx.vb" Inherits="webControl.Ejecutivo" %>
              ...
              <table>
                 <tr>
                     <td id="tab_1" class="pestania_seleccionada" onclick="filtrarPestañaTabs('tab1', 1);">
                         <asp:Label ID="lblTab1" runat="server" Text="Ejecutivo por apertura" />
                     </td>
                     
                     <td id="tab_2" class="pestania_no_seleccionada" onclick="filtrarPestañaTabs('tab2', 1);">
                         <asp:Label ID="lblTab2" runat="server" Text="Ejecutivo General"/>
                     </td>
                </tr>
              </table>
            </div>
